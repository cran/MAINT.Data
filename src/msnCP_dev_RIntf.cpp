...
//  return wrap( msnCP_dev1(param,y,grpind,Config,n,p,k,trace,c2tol,ldRtol,PenF,PenC,nopenalty,MachineEPS,false) );
  return wrap( msnCP_dev1(param,y,grpind,Config,n,p,k,limlnk2,trace,c2tol,ldRtol,PenF,PenC,nopenalty,MachineEPS,false) );
}
...
//  return wrap( msnCP_dev_grad1(param,y,grpind,Config,n,p,k,trace,c2tol,ldRtol,beta0tol,PenF,MachineEPS,false) );
  return wrap( msnCP_dev_grad1(param,y,grpind,Config,n,p,k,limlnk2,trace,c2tol,ldRtol,beta0tol,PenF,MachineEPS,false) );
}
